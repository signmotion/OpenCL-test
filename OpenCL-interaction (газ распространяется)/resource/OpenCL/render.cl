...
inline void createImage(
    ...
    // Альфа-канал определяется чистой плотностью
...
__kernel void render(
        __global float4* out,
        // Количество элементов в материи мира всегда = 256
        //const uint nMatter,
        /* - @todo Не удаётся прозрачно работать с другим размером структуры.
        -          Все необходимые данные дублируются в матрице.
        // Описание материи мира
        __local Matter* md,
        */
    ...
    // При ненулевом dt рассчитываем взаимодействия
    //if (dt >= 0.001f)
    {
    ...
    */
    ...
    // Для цвета: см. @todo в декларации параметров.
    const uint color = s4u[i].color;
